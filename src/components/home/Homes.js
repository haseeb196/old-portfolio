  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 sg:gap-4">
        <h1
          className={`text-[48px] font-semibold uppercase sm:!text-[30px] lg:!text-start sg:text-center sg:text-[44px] ${
        ...
        <p
          className={`text-[22px] sm:!text-[18px] lg:!text-start xl:max-w-[700px] sg:max-w-[600px] sg:text-center sg:text-[20px]  ${
            color ? 'text-black' : 'text-white'
          }`}
        >
